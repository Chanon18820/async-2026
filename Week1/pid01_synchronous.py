...
# ฟังก์ชันจำลองการทำกาแฟให้ลูกค้า 1 คนแบบทีละคน
def make_coffee(customer_name):
    ...
    sleep(5)  # จำลองการทำงานของ Thread นี้ 5 วินาที
...
def main():
    ...
    print(f"{ctime()} | [Main PID: {main_pid}] "
          f"[Main TID: {main_tid}] === เริ่มระบบจำลองลูกค้าแบบ Synchronous ===")

    start_time = time()

    # ชงทำงานตามลำดับทีละคน (ทีละคิว)
